...
<head>
    ...
    <style>
        @import url(
            'https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@300;600&family=Inter:wght@400;500&display=swap'
        );
...
<body>
    <div class="container">
        ...
        <div class="button-group">
            ...
            <a href="https://github.com/DevOP6/mlops-pipeline" class="btn btn-secondary">
                📦 Source Code
            </a>
        </div>
    </div>
